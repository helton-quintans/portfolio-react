...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-black to-slate-900">
      <div className="max-w-screen-xl px-10 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <h3 className=" text-purple-500 mr-5 h-6 sm:h-9">hq</h3>
